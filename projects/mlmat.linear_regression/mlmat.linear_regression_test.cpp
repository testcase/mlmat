...
#include "mlpack.linear_regression.cpp"    // need the source of our object so that we can access it
...
SCENARIO("object produces correct output") {
    ...
    GIVEN("An instance of our object") {
        ...
        test_wrapper<mlmat_linear_regression> an_instance;
        mlmat_linear_regression&              my_object = an_instance;
