...
#include "mlmat.mean_shift.cpp"    // need the source of our object so that we can access it
...
SCENARIO("object produces correct output") {
    ...
    GIVEN("An instance of our object") {
        ...
        test_wrapper<mlmat_mean_shift> an_instance;
        mlmat_mean_shift&              my_object = an_instance;
