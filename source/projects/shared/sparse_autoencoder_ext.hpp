 ...
 */
#ifndef MLPACK_METHODS_SPARSE_AUTOENCODER_SPARSE_AUTOENCODER_EXT_HPP
#define MLPACK_METHODS_SPARSE_AUTOENCODER_SPARSE_AUTOENCODER_EXT_HPP
 ...
 *
 */
class SparseAutoencoderExt
{
public:
    

    SparseAutoencoderExt();
    ...
    SparseAutoencoderExt(const arma::mat& data,
    ...
    void Predict(arma::mat& features, arma::mat& output);
...
#include "sparse_autoencoder_ext_impl.hpp"
