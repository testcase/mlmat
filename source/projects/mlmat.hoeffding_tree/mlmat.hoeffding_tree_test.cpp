...
#include "mlpack.hoeffding_tree.cpp"    // need the source of our object so that we can access it
...
SCENARIO("object produces correct output") {
    ...
    GIVEN("An instance of our object") {
        ...
        test_wrapper<mlmat_hoeffding_tree> an_instance;
        mlmat_hoeffding_tree&              my_object = an_instance;
