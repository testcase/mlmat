...
#include "mlpack.mlp_regressor.cpp"    // need the source of our object so that we can access it
...
SCENARIO("object produces correct output") {
    ...
    GIVEN("An instance of our object") {
        ...
        test_wrapper<mlmat_mlp_regressor> an_instance;
        mlmat_mlp_regressor&              my_object = an_instance;
