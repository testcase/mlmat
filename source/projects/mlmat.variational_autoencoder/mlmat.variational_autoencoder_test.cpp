...
#include "mlmat.variational_autoencoder.cpp"    // need the source of our object so that we can access it
...
SCENARIO("object produces correct output") {
    ...
    GIVEN("An instance of our object") {
        ...
        test_wrapper<mlmat_variational_autoencoder> an_instance;
        mlmat_variational_autoencoder&              my_object = an_instance;
