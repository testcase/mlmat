...
#include "mlpack.lookup.cpp"    // need the source of our object so that we can access it
...
SCENARIO("object produces correct output") {
    ...
    GIVEN("An instance of our object") {
        ...
        test_wrapper<mlmat_lookup> an_instance;
        mlmat_lookup&              my_object = an_instance;
